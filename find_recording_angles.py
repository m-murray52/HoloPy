...
print("Record angle 1 (in air): {0:.3g}".format(np.rad2deg(setup1.theta1_in_air()))+ "degrees")
print("Record angle 2 (in air): {0:.3g}".format(np.rad2deg(setup1.theta2_in_air()))+ "degrees")
